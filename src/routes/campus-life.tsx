...
const CLUBS = [
  { title: "Coding Club", description: "Weekly meetups, competitive programming, and open-source contributions.", image: "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=800&q=80" },
  { title: "Robotics Society", description: "Build and compete with robots — from line followers to autonomous projects.", image: "https://images.unsplash.com/photo-1485827404703-89b55fcc595e?auto=format&fit=crop&w=800&q=80" },
  { title: "Ed-Tech Circle", description: "Explore digital tools, LMS platforms, and classroom innovation.", image: "https://images.unsplash.com/photo-1588702547919-26089e690ecc?auto=format&fit=crop&w=800&q=80" },
  { title: "Photography & Media", description: "Capture campus life and produce content for college channels.", image: "https://images.unsplash.com/photo-1516035069371-29a1b244cc32?auto=format&fit=crop&w=800&q=80" },
  { title: "Sports Association", description: "Football, cricket, basketball, and inter-college tournaments.", image: "https://images.unsplash.com/photo-1546519638-68e109498ffc?auto=format&fit=crop&w=800&q=80" },
  { title: "Community Outreach", description: "Tech literacy workshops and volunteer programs in local schools.", image: "https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?auto=format&fit=crop&w=800&q=80" },
];
