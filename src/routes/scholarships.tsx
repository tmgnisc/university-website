...
const SCHOLARSHIP_BENTO: BentoItem[] = [
  {
    ...
    image: "https://placehold.co/700x500/86001d/ffffff?text=Merit+Award",
    badge: "Up to 75%",
  ...
  },
  {
    ...
    image: "https://placehold.co/500x400/4d0012/ffffff?text=Talent",
    className: "lg:col-span-1",
  },
  {
    ...
    image: "https://placehold.co/600x400/86001d/ffffff?text=Rural+Access",
  ...
  return (
    <PageShell>
      ...
      <SplitSection
        ...
        image="https://placehold.co/800x600/86001d/ffffff?text=Merit+Scholarship"
        bullets={[
      ...
      <SplitSection
        ...
        image="https://placehold.co/800x600/4d0012/ffffff?text=Need+Based"
        imageLeft
        bullets={[
